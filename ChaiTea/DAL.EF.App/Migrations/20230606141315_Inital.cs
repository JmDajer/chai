        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Upc = table.Column<string>(type: "character varying(13)", maxLength: 13, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Beverages_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "BeverageBeverage",
                columns: table => new
                {
                    SubBeverageId = table.Column<Guid>(type: "uuid", nullable: false),
                    ParentBeverageId = table.Column<Guid>(type: "uuid", nullable: false),
                    BeverageBeverageId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BeverageBeverage", x => new { x.ParentBeverageId, x.SubBeverageId });
                    table.ForeignKey(
                        name: "FK_BeverageBeverage_Beverages_ParentBeverageId",
                        column: x => x.ParentBeverageId,
                        principalTable: "Beverages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BeverageBeverage_Beverages_SubBeverageId",
                        column: x => x.SubBeverageId,
                        principalTable: "Beverages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pictures_Beverages_BeverageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewText = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BeverageIngredientId = table.Column<Guid>(type: "uuid", nullable: false),
                    BeverageId = table.Column<Guid>(type: "uuid", nullable: false),
                    IngredientId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BeverageIngredient", x => x.BeverageIngredientId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BeverageTagId = table.Column<Guid>(type: "uuid", nullable: false),
                    BeverageId = table.Column<Guid>(type: "uuid", nullable: false),
                    TagId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BeverageTag", x => x.BeverageTagId);
                    table.ForeignKey(
                        name: "FK_BeverageTag_Beverages_BeverageId",
                        column: x => x.BeverageId,
                        principalTable: "Beverages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BeverageTag_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BeverageBeverage_SubBeverageId",
                table: "BeverageBeverage",
                column: "SubBeverageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Beverages_AppUserId",
                table: "Beverages",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BeverageTag_BeverageId",
                table: "BeverageTag",
                column: "BeverageId");

            migrationBuilder.CreateIndex(
                name: "IX_BeverageTag_TagId",
                table: "BeverageTag",
                column: "TagId");
